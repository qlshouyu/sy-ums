 ...
 */
package com.fsa.syums.service.impl;

import cn.hutool.core.lang.Dict;
import cn.hutool.core.util.ObjectUtil;
import com.fsa.syums.annotation.Log;
import com.fsa.syums.repository.LogRepository;
import com.fsa.syums.service.mapstruct.LogErrorMapper;
import com.fsa.syums.service.mapstruct.LogSmallMapper;
import com.fsa.syums.utils.*;
import lombok.RequiredArgsConstructor;
import com.fsa.syums.domain.SysLog;
import com.fsa.syums.service.SysLogService;
import com.fsa.syums.service.dto.SysLogQueryCriteria;
import com.fsa.syums.service.dto.SysLogSmallDto;
import com.fsa.syums.utils.*;
...
public class SysLogServiceImpl implements SysLogService {
    ...
    public void save(String username, String browser, String ip, ProceedingJoinPoint joinPoint, SysLog sysLog) {
        ...
        if(signature.getName().equals("login") && StringUtils.isNotEmpty(sysLog.getParams())){
            Map<String,Object> obj = JSONUtil.strToObject(sysLog.getParams(),HashMap.class);
            sysLog.setUsername((String) obj.get("username"));
            sysLog.setParams(JSONUtil.objToString(Dict.create().set("username", sysLog.getUsername())));
        }
    ...
    private String getParameter(Method method, Object[] args) {
        ...
        return argList.size() == 1 ? JSONUtil.objToString(argList.get(0)) : JSONUtil.objToString(argList);
    }
