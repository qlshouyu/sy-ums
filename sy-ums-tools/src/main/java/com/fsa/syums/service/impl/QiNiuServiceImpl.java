...
import com.fsa.syums.repository.QiNiuConfigRepository;
import com.fsa.syums.repository.QiniuContentRepository;
...
public class QiNiuServiceImpl implements QiNiuService {
    ...
    public QiniuContent upload(MultipartFile file, QiniuConfig qiniuConfig) {
        ...
        try {
            ...
            DefaultPutRet putRet = JSONUtil.strToObject(response.bodyString(), DefaultPutRet.class);
